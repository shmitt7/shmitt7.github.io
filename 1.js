(function() {  
    ...
    var plugins = [  
        ...
        { url: 'https://shmitt7.github.io/cardMobile.js', name: 'Карточка фильма для телефона', description: 'Меняет визуальный вид полной карточки на телефоне' }, 
        { url: 'https://shmitt7.github.io/cardTV.js', name: 'Карточка фильма', description: 'Меняет визуальный вид полной карточки на TV' },
        { url: 'https://shmitt7.github.io/cards.js', name: 'Карточки в списках', description: 'Меняет визуальный вид карточки в списках' },
