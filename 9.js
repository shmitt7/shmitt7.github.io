(function () {  
    ...
    document.head.insertAdjacentHTML('beforeend', '<style>' +  
        ...
        '.card__overlay{position:absolute;left:0;right:0;bottom:0;padding:0.5em 0.4em 0.25em 0.4em;background:rgba(0,0,0,0.65);border-bottom-left-radius:1em;border-bottom-right-radius:1em;z-index:1;pointer-events:none}' +  
        '.card__overlay::before{content:"";position:absolute;left:0;right:0;bottom:100%;height:1.4em;background:linear-gradient(to bottom,rgba(0,0,0,0) 0%, rgba(0,0,0,0.06) 20%, rgba(0,0,0,0.16) 40%, rgba(0,0,0,0.32) 60%, rgba(0,0,0,0.5) 80%, rgba(0,0,0,0.65) 100%);pointer-events:none}' +  
