(function () {  
    ...
    '.card__overlay{position:absolute;left:0;right:0;bottom:0;padding:3em 0.4em 0em 0.4em;background:linear-gradient(to bottom,rgba(0,0,0,0) 0%,rgba(0,0,0,0.97) 100%);border-bottom-left-radius:1em;border-bottom-right-radius:1em;z-index:1;pointer-events:none}' +  
    ...
    '.card__badge{display:flex;flex-wrap:nowrap;align-items:flex-start;width:100%;margin-left:0.15em;overflow:hidden}' +  
    ...
    '.card__badge-right{display:flex;align-items:flex-start;flex-shrink:0;margin-left:auto;margin-right:0.3em;transform:translateY(-0.05em)}' +  
