(function () {  
    ...
    '.card__status-row{display:flex;align-items:baseline;margin-left:0.3em;margin-bottom:0.08em;line-height:1;overflow:hidden;white-space:nowrap;min-width:0}' +  
    ...
    '.card__badge{display:flex;flex-wrap:nowrap;align-items:center;width:100%;margin-left:0.3em;overflow:hidden}' +  
