(function () {  
    ...
    document.head.insertAdjacentHTML('beforeend', '<style>' +  
        ...
        '.card__overlay-title{font-size:1.35em;font-weight:600;line-height:1.1;color:#fff;text-shadow:0 1px 0 rgba(255,255,255,0.25),0 2px 1px rgba(0,0,0,0.4),0 3px 6px rgba(0,0,0,0.85);overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;line-clamp:2;-webkit-box-orient:vertical;margin-bottom:0.15em;margin-left:0.05em}' +  
        '.card__status-row{display:flex;align-items:baseline;margin-left:0.05em;margin-bottom:0.02em;line-height:1;overflow:hidden;white-space:nowrap;min-width:0}' +  
        ...
        '.card__badge{display:flex;flex-wrap:nowrap;align-items:baseline;width:100%;margin-left:0.05em;box-sizing:border-box;overflow:hidden}' +  
        ...
        '.card__badge-right .card__vote .source--name{position:relative!important;top:0.12em!important}' +  
