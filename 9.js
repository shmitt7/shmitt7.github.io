(function () {  
    ...
    document.head.insertAdjacentHTML('beforeend', '<style>' +  
        ...
        '.card__overlay{position:absolute;left:0;right:0;bottom:0;padding:0.5em 0.4em 0.25em 0.4em;background:linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.9) 100%);border-bottom-left-radius:1em;border-bottom-right-radius:1em;z-index:1;pointer-events:none}' +  
        '.card__overlay::before{content:"";position:absolute;left:0;right:0;bottom:100%;height:1.4em;background:linear-gradient(to bottom,rgba(0,0,0,0) 0%, rgba(0,0,0,0.06) 20%, rgba(0,0,0,0.16) 40%, rgba(0,0,0,0.32) 60%, rgba(0,0,0,0.5) 80%, rgba(0,0,0,0.6) 100%);pointer-events:none}' +  
        '.card__overlay-title{font-size:1.45em;font-weight:500;line-height:1.1;color:#fff;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;line-clamp:2;-webkit-box-orient:vertical;margin-bottom:0.15em}' +  
        ...
        '.card__status-row .card__status .tvs-text{font-size:0.95em;font-weight:500;color:#ccc;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;flex-shrink:1;min-width:0}' +  
        '.card__badge{display:flex;flex-wrap:nowrap;align-items:center;width:100%;overflow:hidden}' +  
        '.card__badge-year{font-size:0.95em;color:#ccc;flex-shrink:0}' +  
        ...
        '.card__badge-year+.card__badge-genre::before,.card__badge-year+.card__type::before{content:"\u2022";margin-right:0.4em;color:#ccc;font-size:0.95em}' +  
        '.card__badge .card__type{position:static!important;top:auto!important;left:auto!important;background:none!important;padding:0!important;border-radius:0!important;font-size:0.95em!important;color:#ccc!important}' +  
        '.card__badge-right{display:flex;align-items:center;flex-shrink:0;margin-left:auto}' +  
        '.card__badge-right>*+*{margin-left:0.4em}' +  
        '.card__badge-right .card__quality{position:static!important;left:auto!important;bottom:auto!important;padding:0!important;background:none!important;color:#ddd!important;font-size:1.1em!important;font-weight:500;border-radius:0!important}' +  
        '.card__badge-right .card__quality>div{display:inline}' +  
        '.card__badge-right .card__vote{position:static!important;right:auto!important;bottom:auto!important;background:none!important;color:#ddd!important;font-size:1.1em!important;font-weight:500;padding:0!important;border-radius:0!important}' +  
