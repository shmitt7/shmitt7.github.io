(function () {  
    ...
    var css = [  
        ...
        /* ── скрыть элементы просмотра/эпизодов на обычных карточках ── */  
        ...
        '.ccs__bar {',  
            ...
            'padding: 1.8em 0.6em 0.3em 0.6em;',  
        ...
        var observer = new MutationObserver(function (mutations) {  
            for (var i = 0; i < mutations.length; i++) {  
                ...
                for (var j = 0; j < added.length; j++) {  
                    ...
                    } else if (node.classList.contains('card__type') || node.classList.contains('card__quality') || node.classList.contains('card__vote')) {  
                        relocateLate(node);  
