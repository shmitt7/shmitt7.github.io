(function () {
    ...
    var HIDDEN_POS = '-16.5em'; // скрыто за левым краем (15em ширина + 1.5em запас)
    var VISIBLE_POS = '1em';    // отступ от левого края экрана когда открыто
    ...
    function applyMenuStyles() {
        ...
        left.style.setProperty('border-radius', '1.5em',                         'important'); // все 4 угла
    ...
    var observer = new MutationObserver(function (mutations) {
        for (var i = 0; i < mutations.length; i++) {
            ...
            if (leftEl) {
                // Блокируем transform от Lampa, управляем только через left
