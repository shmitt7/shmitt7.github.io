...
function init() {
    ...
    Lampa.Listener.follow('full', function(e) {
        ...
        setTimeout(function() {
            ...
            if (reactEl) main.append($('<div class="fsc-center-row"></div>').append(reactEl));
            main.append(buttons);
