...
function init() {
    ...
    Lampa.Listener.follow('full', function(e) {
        ...
        setTimeout(function() {
            ...
            right.find('.fsc-reactions-badge').remove();
            right.append(main);
