            ...
            setTimeout(() => {
                ...
                if (movie.id) {
                    ...
                    const applyLogo = (src) => {
                        ...
                        img.onerror = () => { title.html(origHtml); if (formatted !== null) title.addClass('fsc-title-split'); };
                        img.src = src;
