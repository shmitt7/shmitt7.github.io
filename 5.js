        ...
        Lampa.Listener.follow('full', (e) => {
            ...
            setTimeout(() => {
                ...
                if (movie.id) {
                    ...
                    if (formatted !== null) title.html(origHtml);
