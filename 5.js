(function(){  
    function startPlugin(){  
        ...
        var css = [  
            ...
            '.settings__content,.selectbox__content{top:'+RIGHT+'em!important;bottom:'+RIGHT+'em!important;height:auto!important;max-height:calc(100vh - '+(RIGHT*2)+'em)!important;border-radius:1em!important;border:2px solid rgba(255,255,255,.25)!important;overflow:hidden!important}',  
            'body.black--style .settings__content,body.black--style .selectbox__content{background:#000!important}',  
            'body.settings--open .settings__content,body.selectbox--open .selectbox__content{transform:translate3d(calc(-100% - '+RIGHT+'em),0,0)!important}',  
        ...
        function update(){  
            ...
            var maxHR = window.innerHeight - RIGHT * 2 * fs;  
