(function() {  
    ...
    // Стили для лейблов фильмов - синий, для сериалов берётся стандартная красная метка
    ...
    // Жанры которые не входят в список Специфичных и меняем названия "Телевизионный фильм" → "Телефильм", "Боевик и Приключения" → "Экшен"
    const allGenres = {   
    ...
    // Определение лейбла по данным карточки и проверка на актера  
    function getLabel(cardData) {  
        ...
        // Специфичные жанры (высший приоритет)  
