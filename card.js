            ...
            if (movie.id) {
                ...
                if (logoCache[cacheKey] !== undefined) {  
                    ...
                    $.get(  
                        ...
                        function(data) {  
                            if (currentToken !== token) return;  
                            const logos = (data.logos || []).filter(function(l) { return l.file_path && l.file_path.slice(-4) !== '.svg' && l.iso_639_1 === 'ru'; });  
